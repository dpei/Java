...
public class encodeCaesar {
    ...
    public void testEncryptMsg(){
        System.out.println(encryptMsg("ee", 23));
        System.out.println(encryptMsg("ee", 8));
    ...
    public void testTwoKeyEncrypt(){
        System.out.println(twoKeyEncrypt("FIRST LEGION ATTACK EAST FLANK!eeeeee", 23, 17));
    }
}
