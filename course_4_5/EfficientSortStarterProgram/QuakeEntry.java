/** Implements new compareTo method to sort data with two parameters
 * The first papameter is magnitude
 * The second parameter is depth
 * 
 * 
...
public class QuakeEntry implements Comparable<QuakeEntry>{
    // List and arrays can be sorted with Collections.sort once the public interface 
    // Comparable<> is imported.
    // In addition, the method compareTo() method should be defined in the class
    // so that the Collections.sort knows what to sort.
    ...
    public int compareTo(QuakeEntry loc) {        
        if (magnitude != loc.getMagnitude()){
            // the Double.compare function is a public function
